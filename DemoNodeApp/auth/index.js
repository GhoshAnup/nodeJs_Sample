...
(function (auth) {
  ...
  auth.init = function (app) {
    ...
    app.get("/login", function (req, res) {
      res.render("login", { title: "Login to Demo Node App", message: req.flash("loginError") });
    });
    ...
    app.get("/register", function (req, res) {
      res.render("register", { title: "Register for Demo Node App", message: req.flash("registrationError") });
    });
